...
AdminDashboard.schemas.newUser = new SimpleSchema({
    email: {
        type: String,
        label: AdminDashboard.geti18n("email")
    },
    chooseOwnPassword: {
        type: Boolean,
        label: AdminDashboard.geti18n('resetPasswordLable'),
        defaultValue: true
    },
    password: {
        type: String,
        label: AdminDashboard.geti18n('password'),
        optional: true
    },
    sendPassword: {
        type: Boolean,
        label: AdminDashboard.geti18n('sendPasswordLable'),
        optional: true
    }
});
