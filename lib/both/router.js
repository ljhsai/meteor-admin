...
Router.route("adminDashboardUsersView", {
    ...
    onAfterAction: function () {
        Session.set('admin_title', AdminDashboard.geti18n("users"));
...
Router.route("adminDashboardUsersNew", {
    ...
    onAfterAction: function () {
        Session.set('admin_title', AdminDashboard.geti18n("users"));
        Session.set('admin_subtitle', AdminDashboard.geti18n("newUser"));
...
Router.route("adminDashboardUsersEdit", {
    ...
    onAfterAction: function () {
        Session.set('admin_title', AdminDashboard.geti18n("users"));
        Session.set('admin_subtitle', AdminDashboard.geti18n('editUser') + this.params._id);
