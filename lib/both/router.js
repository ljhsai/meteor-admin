AdminController = RouteController.extend({
    ...
    onBeforeAction: function () {
        ...
        if (!Roles.userIsInRole(Meteor.userId(), ['admin'])) {
            ...
            if (typeof ( AdminConfig ? AdminConfig.nonAdminRedirectRoute : null) === 'string') {
...
Router.route("adminDashboardUsersView", {
    ...
    onAfterAction: function () {
        Session.set('admin_title', TAPi18n.__("users"));
        Session.set('admin_subtitle', 'View');
        return Session.set('admin_collection_name', TAPi18n.__("users"));
    }
});
...
Router.route("adminDashboardUsersNew", {
    ...
    onAfterAction: function () {
        Session.set('admin_title', TAPi18n.__("users"));
        Session.set('admin_subtitle', TAPi18n.__("newUser"));
...
Router.route("adminDashboardUsersEdit", {
    ...
    onAfterAction: function () {
        Session.set('admin_title', TAPi18n.__("users"));
        Session.set('admin_subtitle', TAPi18n.__('editUser') + this.params._id);
        Session.set('admin_collection_page', 'edit');
        Session.set('admin_collection_name', TAPi18n.__("users"));
