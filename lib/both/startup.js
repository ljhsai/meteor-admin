...
adminCreateRouteViewOptions = function (collection, collectionName) {
    ...
    options = {
        ...
        onAfterAction: function () {
            ...
            return (_ref = collection.routes) != null ? (_ref1 = _ref.view) != null ? _ref1.onAfterAction : void 0 : void 0;
        }
    };
    return _.defaults(options, (_ref = collection.routes) != null ? _ref.view : void 0);
};
...
adminCreateRouteNewOptions = function (collection, collectionName) {
    ...
    return _.defaults(options, (_ref = collection.routes) != null ? _ref["new"] : void 0);
};
