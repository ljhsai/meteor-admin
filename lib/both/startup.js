...
adminEditButton = {
    ...
    createdCell: function (node, cellData, rowData) {
        return $(node).html(Blaze.toHTMLWithData(Template.adminEditBtn, {_id: cellData}, node));
    },
    width: '40px',
    orderable: false
};
...
adminDelButton = {
    ...
    title: 'Delete',
    createdCell: function (node, cellData, rowData) {
        return $(node).html(Blaze.toHTMLWithData(Template.adminDeleteBtn, {_id: cellData}, node));
    },
    width: '40px',
    orderable: false
};
...
adminCreateTables = function (collections) {
    return _.each( AdminConfig ? AdminConfig.collections : null, function (collection, name) {
        var columns;
